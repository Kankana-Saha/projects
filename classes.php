...
<body>
    <nav style="color: brown;">
        ...
        <center>
        <div  class="a" style="margin-top: 200px; padding-bottom: 50px;padding-top: 10px;" >
            <h1 style="font-size: 10mm; margin-top:100px; ">Classes</h1>
           
            <img src="classess.jpg" alt="" style="height: 200px ;width: 200px;">
            <p class="a" style="margin-top: 50px; "> Our classes will be started at 5AM and end on 10PM. You will get best services here.</p>
           <h2 style="margin-top: 10px; font-size:10mm;">Packages<h2>

            <ul style=" font-size:4mm;">Gym:
                <li> Monthly-599Rs.</li>
                <li> Yearly-6500Rs.</li>
            </ul>
            <ul style=" font-size:4mm;">Zumba:
                <li> Monthly-699Rs.</li>
                <li> Yearly-7500Rs.</li>
            </ul>
            <ul style=" font-size:4mm;">Personal training:
                <li> Monthly-999Rs.</li>
                <li> Yearly-1100Rs.</li>
            </ul>
        </div>
